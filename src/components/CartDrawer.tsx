            ...
            {cart.length > 0 && (
              <div className="p-6 border-t border-olive/10  bg-olive/5 ">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-xl font-serif text-olive ">Rs {subtotal.toFixed(0)}</span>
                </div>
                <p className="text-xs text-olive/60  text-center mb-4">
                  Shipping & taxes calculated at checkout.
                </p>
                <button className="w-full py-4 bg-olive text-creme   rounded-full hover:bg-olive/90  transition-colors uppercase tracking-widest text-sm">
                  Checkout
                </button>
              </div>
            )}
